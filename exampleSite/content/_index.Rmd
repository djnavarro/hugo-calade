---
title: Home
summary: "Slumdown: A Hugo theme and R package by Danielle Navarro"
---
...
Once the slumdown package is installed, the tutorial in the [posts](/post/) section of this site will walk you through the rest of the process. For folks who already know what they are doing, here's the quick guide to setting up a Hugodown site on GitHub Pages:

```{r, eval=FALSE}
slumdown::create_hugodown_slum("my-slumdown-site")
