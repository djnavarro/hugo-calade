...
Blogdown will download the slum template and generate the example site (i.e., this one!), and you are ready to get started. If you want to use hugodown, the installation command is this:

```{r, eval=FALSE}
slumdown::create_hugodown_slum("path_to_blog_folder")
```

When you do this, hugodown will download the slum template, configure the site appropriately and build the site. 
