...
summary: "A simple project page illustrating how user-defined themes in slumdwon can be used as the basis of individual pages and ggplot2 figures. It doesn't do very much."
header:
